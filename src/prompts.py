...
1. ENTITY EXTRACTION:
   ...
   - Format 'id' as a lowercase slug (e.g. 'person_karkuvel', 'project_chronograph', 'commit_abc123').
   - Standardize 'name' while preserving exact hashes, usernames, and issue keys (e.g., 'abc1234', 'PROJ-123', '@aathi').
...
3. GRAPH TRIPLES GENERATION:
   - Formulate triples in (subject, predicate, object) format corresponding to extracted relationships.
   - Subject and Object MUST match extracted entities.

4. STRICT FAITHFULNESS & ZERO HALLUCINATION:
